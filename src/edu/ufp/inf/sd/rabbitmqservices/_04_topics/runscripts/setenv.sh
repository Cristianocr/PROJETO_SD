...
export JAVAPROJ=/Users/cristianojoaquimsoaresdarocha/Desktop/Faculdade/Faculdade_23_24/2_semestre/SD/SD
...
export PACKAGE=_04_topics
export QUEUE_NAME_PREFIX=topics
export EXCHANGE_NAME_PREFIX=topic_log
export PRODUCER_CLASS_PREFIX=EmitLogTopic
export CONSUMER_CLASS_PREFIX=ReceiveLogsTopic
