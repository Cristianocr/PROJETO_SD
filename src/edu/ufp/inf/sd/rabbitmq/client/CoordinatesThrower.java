...
public class CoordinatesThrower extends Thread {
    ...
    boolean coordinateIsValid(int newX, int newY) throws IOException {
        if (!player[id].alive) {
            return false;
        }
    ...
    void keyCodePressed(int keyCode) throws IOException {
        switch (keyCode) {
            case KeyEvent.VK_W:
                up = true;
    ...
    void keyCodeReleased(int keyCode) throws IOException {
