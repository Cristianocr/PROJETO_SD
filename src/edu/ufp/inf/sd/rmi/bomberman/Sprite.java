package edu.ufp.inf.sd.rmi.bomberman;
...
public class Sprite {
   ...
   static void loadImages() {
      try {
         ...
         String basePath = "/Users/cristianojoaquimsoaresdarocha/Desktop/Faculdade/Faculdade_23_24/2_semestre/SD/PROJETO_SD/src/edu/ufp/inf/sd/rmi/bomberman/images/";
         ...
         for (String color : personColors)
            for (String keyWord : personKeyWords)
               ht.put(color+"/"+keyWord, ImageIO.read(new File(basePath + "person/"+color+"/"+keyWord+".png")));
      } catch (IOException e) {
