...
public class Game extends JPanel {
   ...
   public void paintComponent(Graphics g) {
      ...
      // System.out.format("%s: %s [%04d, %04d]\n", edu.ufp.inf.sd.rmi.bomberman.Game.you.color, edu.ufp.inf.sd.rmi.bomberman.Game.you.status, edu.ufp.inf.sd.rmi.bomberman.Game.you.x, edu.ufp.inf.sd.rmi.bomberman.Game.you.y);;
