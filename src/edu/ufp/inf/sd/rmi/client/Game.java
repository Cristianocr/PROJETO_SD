...
public class Game extends JPanel {
    ...
    Game(Client client, int width, int height) {
        ...
        try {
            ...
            you = new Player(this, client.id, this);
            enemy1 = new Player(this, (client.id + 1) % Const.QTY_PLAYERS, this);
            enemy2 = new Player(this, (client.id + 2) % Const.QTY_PLAYERS, this);
            enemy3 = new Player(this, (client.id + 3) % Const.QTY_PLAYERS, this);
