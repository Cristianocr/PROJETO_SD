package edu.inf.ufp.sd.rmi._06_visitor.client;

import edu.ufp.inf.sd.rmi._06_visitor.server.ElementFolderRI;
import edu.ufp.inf.sd.rmi._06_visitor.server.VisitorsFoldersOperationCreateFile;
import edu.ufp.inf.sd.rmi._06_visitor.server.VisitorsFoldersOperationDeleteFile;
...
public class VisitorClient {
    ...
    private void playService() {
        try {
            ...
            VisitorsFoldersOperationCreateFile visitorCreate = new VisitorsFoldersOperationCreateFile("text.txt");
            this.elementFolderRI.acceptVisitor(visitorCreate);

            VisitorsFoldersOperationDeleteFile visitorDelete = new VisitorsFoldersOperationDeleteFile("text.txt");
