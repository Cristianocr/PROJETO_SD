package edu.inf.ufp.sd.rmi._03_pingpong.server;
...
public class PingServer {
    ...
    public static void main(String[] args) {
        if (args != null && args.length < 3) {
            System.err.println("usage: java [options] edu.ufp.sd._03_pingpong.server.PingServer <rmi_registry_ip> <rmi_registry_port> <service_name>");
            System.exit(-1);
        } else {
            //1. ============ Create Servant ============
